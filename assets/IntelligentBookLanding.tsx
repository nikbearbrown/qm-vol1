      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="max-w-2xl mx-auto text-center mb-14">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            Traditional textbooks give you the information — Medhavy textbooks help you
    ...
    <section className="py-20 bg-background">
      <div className="container px-4 md:px-6 mx-auto max-w-3xl text-center">
        ...
        <p className="text-muted-foreground mb-10 leading-relaxed">
          ...
          learning experience — from chapter navigation to the built-in study companion.
        </p>
          ...
          {preview && (
            <div className="rounded-lg border border-border bg-background p-6 shadow-sm">
              ...
              <p
                ...
                style={{ color: 'var(--bb-5)', opacity: 0.5 }}
              >
                {preview.excerpt.slice(280, 420)}…
              </p>
              <button
                className="mt-4 text-xs font-semibold border rounded-full px-4 py-1.5 transition-colors hover:bg-foreground hover:text-background"
                style={{ borderColor: 'var(--bb-1)', color: 'var(--bb-1)' }}
              ...
              <div key={part.number}>
                <div className="flex items-center gap-3 mb-5">
                  <span
                    ...
                    style={{ color: 'var(--bb-5)' }}
                  >
                    Part {part.number} · {part.chapterRange}
                  </span>
...
function ChapterRow({
  ...
  return (
    ...
    >
      ...
      <span className="flex-none text-muted-foreground group-hover:text-foreground transition-colors">
        ◻
      </span>
    </Link>
  )
